...
class EDDScheduler:
    ...
    def schedule_step(self) -> bool:
        ...
        # 1. EDD规则：选择交货期最早的作业的当前工序
        # 如果有多个作业的交货期相同，选择剩余加工时间更少的作业
        ...
        # 3. 计算开始时间
        # 开始时间取决于：1) 作业中前一道工序的完成时间 2) 机器的可用时间
        job_ready_time = 0
...
def main():
    """主函数：读取文件，执行EDD调度，展示并保存甘特图，导出指标到Excel"""
    print("=" * 80)
    print("基于EDD（最早交货期优先）规则的柔性作业车间调度（文件驱动）")
    print("=" * 80)
